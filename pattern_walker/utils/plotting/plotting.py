...
def plot_tree(G,partition=[]):
    ...
    nx.draw_networkx_nodes(G,pos,nodelist=[G.root],node_color='r',linewidths=10,node_size=3000.) #root in red
    nx.draw_networkx_nodes(G,pos,nodelist=[G.target_node],node_color='b',linewidths=10,node_size=3000) #target in blue

...
def plot_tree(G,partition=[]):
    ...
    nx.draw_networkx_nodes(G,pos,nodelist=[G.root],node_color='r',node_size=5000.) #root in red
    nx.draw_networkx_nodes(G,pos,nodelist=[G.target_node],node_color='g',node_size=5000) #target in green
    nx.draw_networkx_nodes(G,pos,nodelist=partition,node_size=6000,node_shape='h',linewidths=10,edgecolors='k')
    return fig_handle
